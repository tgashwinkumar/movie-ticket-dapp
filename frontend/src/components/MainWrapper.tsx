...
const MainWrapper = (): ReactElement => {
  ...
  return (
    <div className="bg-gray-100 h-screen w-screen overflow-hidden flex p-4">
      <section className="w-1/3 space-y-6">
        <div className="flex space-x-4 items-center">
          <img src={Logo} alt="" className="h-32 w-auto" />
          <div className="space-y-1">
            <h1 className="text-3xl text-teal-900 font-black">dAppTickets</h1>
    ...
    <div className="w-full">
      {active ? (
        <div className="w-full space-y-6 flex flex-col items-center">
          <div className="flex w-full space-x-4 items-center text-teal-600">
          ...
          <button
            ...
            className="px-12 py-2 rounded-full border-teal-700 border-4  hover:shadow-xl text-teal-700 text-xl font-bold"
          >
            Disconnect
          </button>
        </div>
